...
class GoroGoroBoardCreatorTests: XCTestCase {
    ...
    func test_dobutsuBoard_hasCorrectSetup() {
        ...
        XCTAssertTrue(board.pieceAt(Position(x: 0, y: 0)) is Cat)
        XCTAssertTrue(board.pieceAt(Position(x: 1, y: 0)) is Dog)
        XCTAssertTrue(board.pieceAt(Position(x: 2, y: 0)) is Lion)
        XCTAssertTrue(board.pieceAt(Position(x: 3, y: 0)) is Dog)
        XCTAssertTrue(board.pieceAt(Position(x: 4, y: 0)) is Cat)
        ...
        XCTAssertTrue(board.pieceAt(Position(x: 1, y: 2)) is Chick)
        XCTAssertTrue(board.pieceAt(Position(x: 2, y: 2)) is Chick)
        XCTAssertTrue(board.pieceAt(Position(x: 3, y: 2)) is Chick)
        XCTAssertNil(board.pieceAt(Position(x: 4, y: 2)))

        XCTAssertNil(board.pieceAt(Position(x: 0, y: 3)))
        XCTAssertTrue(board.pieceAt(Position(x: 1, y: 3)) is Chick)
        XCTAssertTrue(board.pieceAt(Position(x: 2, y: 3)) is Chick)
        XCTAssertTrue(board.pieceAt(Position(x: 3, y: 3)) is Chick)
        ...
        XCTAssertTrue(board.pieceAt(Position(x: 0, y: 5)) is Cat)
        XCTAssertTrue(board.pieceAt(Position(x: 1, y: 5)) is Dog)
        XCTAssertTrue(board.pieceAt(Position(x: 2, y: 5)) is Lion)
        XCTAssertTrue(board.pieceAt(Position(x: 3, y: 5)) is Dog)
        XCTAssertTrue(board.pieceAt(Position(x: 4, y: 5)) is Cat)
    }
}
